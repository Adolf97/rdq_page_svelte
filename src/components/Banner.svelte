<script>
    ...
    import BannerImg from '$lib/images/banner.jpg'
</script>

<div class="banner_container">
    <img src={BannerImg} alt="Banner: Buildings">
    <div class="banner-info_container">
        ...
        <div class="redes-sociales_container">
            ...
            <a href="https://www.instagram.com/rdq_mexico/" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-instagram icon-redes" viewBox="0 0 16 16">
            ...
            <a href="https://www.linkedin.com/in/adolfo-ram%C3%ADrez-31b733179/" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-linkedin icon-redes" viewBox="0 0 16 16">
